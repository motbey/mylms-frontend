...
export const settingsTiles: SettingsTileConfig[] = [
  { slug: 'settings.themes_text', label: 'Portal Themes & Text', description: 'Customise colours and global text.', action: 'openThemeModal', icon: React.createElement(PaletteIcon) },
  { slug: 'settings.logo', label: 'Logo', description: 'Upload your company logo.', action: 'openLogoModal', icon: React.createElement(ImageIcon) },
  { slug: 'settings.integrations', label: 'Integrations', description: 'Connect with third-party apps.', to: '/admin/settings/integrations', icon: React.createElement(PuzzleIcon) },
  { slug: 'settings.signup_toggle', label: 'Sign-Up Toggle', description: 'Enable or disable public sign-ups.', action: 'openSignupToggleModal', icon: React.createElement(UserPlusIcon) },
];

const tilesBySlug = new Map(settingsTiles.map(tile => [tile.slug, tile]));

export function getSettingsTileBySlug(slug: string): SettingsTileConfig | undefined {
