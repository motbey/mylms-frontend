    ...
    <HashRouter>
      <Layout>
        <Routes>
          ...
          <Route path="/admin/content/upload-scorm-s3" element={<UploadScormToS3 />} />
          <Route path="/admin/content/competencies" element={<AdminCompetencies />} />
          ...
          <Route path="/admin/forms/submissions" element={<AdminFormSubmissionsListPage />} />
          <Route path="/admin/forms/submissions/:submissionId" element={<AdminFormSubmissionReviewPage />} />
